...
function StepBody({id}) {
  if (id === 'prepare') return <>
    ...
    <p className="cert-note">시작 조건: 07번에서 실제 문서 인덱스를 만든 상태여야 합니다. docstore_index 폴더 또는 docstore_index.tgz가 없다면 <a className="cert-inline-link" href="/notes/07-vectorstores#section-4">07번의 인덱스 저장</a>부터 마무리하세요. 이 가이드는 수업의 course/embedding 설정을 사용합니다.</p>
    ...
    <OriginalCell id="setup" title="첫 번째 할 일 · 08번 설정 셀을 그대로 실행"/>
