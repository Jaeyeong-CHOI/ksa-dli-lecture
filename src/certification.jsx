...
function StepBody({id}) {
  if (['start', 'index-setup', 'index-docs', 'index-build', 'index-save'].includes(id)) return <Certification07 id={id} Paste={Paste} Checkpoint={Checkpoint}/>;
  if (id === 'prepare') return <>
    ...
    <p className="cert-note">앞 단계에서 07-D 완료와 저장 후 검색 OK를 확인했다면 준비된 상태입니다. 아직 하지 않았다면 이 페이지의 <a className="cert-inline-link" href="#index-setup">07-A부터</a> 순서대로 진행하세요. 별도 해설 페이지로 이동할 필요는 없습니다.</p>
