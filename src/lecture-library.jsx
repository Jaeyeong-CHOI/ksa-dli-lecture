...
export function LectureLibrary({lecture,Link,course,program}) {
 ...
 return <main id="main" className="slides-page">
  ...
  <a className="outline-button lecture-resource-link" href="https://dam-cdn.nvd.orangelogic.com/AssetLink/e3d6dnl072557c05146bwe4gfu2ykw7o.pdf" target="_blank" rel="noopener noreferrer" aria-label="NVIDIA 교육·자격증 학습 로드맵 PDF, 새 탭에서 열기"><span>NVIDIA 교육·자격증 학습 로드맵 (PDF)</span><ArrowUpRight size={17} aria-hidden="true"/></a>
