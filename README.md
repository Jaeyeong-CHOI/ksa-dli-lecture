...
Introduction to LLM(1번)은 사용자 요청으로 **2026년 9월 14일 11:51(KST)에 즉시 공개**했습니다. RAGAS·QuCo RAG(2·3번)도 사용자 요청으로 **2026년 9월 14일 21:37(KST)에 즉시 공개**했습니다. Recent RAG(4번)는 사용자 요청으로 **2026년 9월 15일 최신 20쪽 자료로 교체·즉시 공개**했습니다. 나머지 강의 PDF는 한국시간 **16일 18시(5번 Search Ranking), 17일 18시(6번 Product Building)**에 공개됩니다. 공개 전에는 예정 시간과 잠금 화면만 표시합니다. 브라우저 시계가 아니라 서버에서 공개 여부를 판단하며, PDF 직접 요청과 챗봇의 미공개 슬라이드 검색을 제한합니다. 공개 논문 및 실습 자료는 계속 이용할 수 있습니다.
...
아직 준비 중인 실습은 공통 메뉴와 일반 페이지의 검색 결과에서 숨깁니다. `/agentic-coding` 직접 주소로만 진입하며, 해당 페이지 안에서는 실습 전환·검색·기존 단계 링크·다운로드를 유지합니다.
